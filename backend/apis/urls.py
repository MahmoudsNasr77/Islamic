...
from .views import HadithAPIView,HadithCreateAPIView,HadithUpdateAPIView,HadithRetrieveAPIView,HadithNarratorAPIView
urlpatterns = [
...
path("narrator/", HadithNarratorAPIView.as_view(), name="narrator"),
